...
import org.jmqtt.core.packet.PubCompPacket;
import org.jmqtt.core.util.MqttUtils;

/**
 * @author andrea
 */
class PubCompEncoder extends DemuxEncoder<PubCompPacket> {

    @Override
    protected void encode(ChannelHandlerContext chc, PubCompPacket msg, ByteBuf out) {
        out.writeByte(AbstractPacket.PUBCOMP << 4);
        out.writeBytes(MqttUtils.encodeRemainingLength(2));
