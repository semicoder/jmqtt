...
public class MqttUtils {
    ...
    public static byte encodeFlags(AbstractPacket message) {
        byte flags = 0;
    ...
    public static String msgType2String(int type) {
        switch (type) {
            case AbstractPacket.CONNECT:
                return "CONNECT";
            case AbstractPacket.CONNACK:
                return "CONNACK";
            case AbstractPacket.PUBLISH:
                return "PUBLISH";
            case AbstractPacket.PUBACK:
                return "PUBACK";
            case AbstractPacket.PUBREC:
                return "PUBREC";
            case AbstractPacket.PUBREL:
                return "PUBREL";
            case AbstractPacket.PUBCOMP:
                return "PUBCOMP";
            case AbstractPacket.SUBSCRIBE:
                return "SUBSCRIBE";
            case AbstractPacket.SUBACK:
                return "SUBACK";
            case AbstractPacket.UNSUBSCRIBE:
                return "UNSUBSCRIBE";
            case AbstractPacket.UNSUBACK:
                return "UNSUBACK";
            case AbstractPacket.PINGREQ:
                return "PINGREQ";
            case AbstractPacket.PINGRESP:
                return "PINGRESP";
            case AbstractPacket.DISCONNECT:
                return "DISCONNECT";
            default:
