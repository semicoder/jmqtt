...
import org.jmqtt.broker.config.SslProperties;
...
public class DefaultSslContextCreator implements ISslContextCreator {
    ...
    public DefaultSslContextCreator(SslProperties props) {
        this.props = props;
    }

    @Override
    public SSLContext initSSLContext() {
        final String jksPath = props.getJksPath();
        ...
        final String keyManagerPassword = props.getKeyManagerPassword();
        ...
        boolean needsClientAuth = props.getNeedsClientAuth();
